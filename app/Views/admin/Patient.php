            ...
            <table class="table">
                ...
                <?php foreach($listofpatients as $patients): ?>
                    ...
                    <td>
                            ...
                            <a href="<?= base_url('admin/PatientRecords/' . $patients['patient_id']); ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('admin/patients/insertPatient') ?>" method="post">
                    <div class="row mb-3">
                        <div class="col-md-6">
...
<div class="modal fade" id="updatePatientModal" tabindex="-1" aria-labelledby="updatePatientModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updatePatientModalLabel"><i class="fas fa-edit me-2"></i>Update Patient</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?= site_url('admin/updatePatient') ?>" method="POST">
